...
# Load images & sounds:
gear_icon = arcade.load_texture("backgammon\Images\gear_icon.png")
exit_icon = arcade.load_texture("backgammon\Images\exit_icon.png")
quit_icon = arcade.load_texture("backgammon\Images\quit_icon.png")

delete_icon = arcade.load_texture("backgammon\Images\delete_icon.png")
darkPiece_icon = arcade.load_texture("backgammon\Images\darkPiece.jpg")
lightPiece_icon = arcade.load_texture("backgammon\Images\lightPiece.png")
restart_icon = arcade.load_texture("backgammon\Images\\restart_icon.png")

delete_icon2 = arcade.load_texture("backgammon\Images\delete_icon2.png")
darkPiece_icon2 = arcade.load_texture("backgammon\Images\darkPiece2.jpg")
lightPiece_icon2 = arcade.load_texture("backgammon\Images\lightPiece2.png")
restart_icon2 = arcade.load_texture("backgammon\Images\\restart_icon2.png")

delete_icon3 = arcade.load_texture("backgammon\Images\delete_icon3.png")
darkPiece_icon3 = arcade.load_texture("backgammon\Images\darkPiece3.jpg")
lightPiece_icon3 = arcade.load_texture("backgammon\Images\lightPiece3.png")
restart_icon3 = arcade.load_texture("backgammon\Images\\restart_icon3.png")
...
darkCheckerColor = arcade.color.BLACK_OLIVE
lightCheckerColor = arcade.color.LIGHT_SKY_BLUE
darkTextColor = arcade.color.BLACK
lightTextColor = arcade.color.AERO_BLUE
lightTextColor2 = arcade.color.ALMOND
Background = arcade.color.LIGHT_GREEN
board_color = arcade.color.DARK_GREEN
board_border = arcade.color.DARK_BROWN
Point1 = arcade.color.LIGHT_APRICOT
Point2 = arcade.color.DARK_ORANGE
...
def drawSignature(version):
    arcade.draw_text("Backgammon ", 1000, 25, black, 10)
...
def diceSub(baseX, baseY, num, color, override=False, altColor=black):
    p1 = [baseX + 20, baseY + 20]
    p2 = [baseX + 20, baseY + 38]
    p3 = [baseX + 20, baseY + 57]
    p4 = [baseX + 38, baseY + 38]
    p5 = [baseX + 57, baseY + 20]
    p6 = [baseX + 57, baseY + 38]
    p7 = [baseX + 57, baseY + 57]
    arcade.draw_rectangle_filled(baseX + 38, baseY + 38, 75, 75, color if not override else altColor)
    arcade.draw_rectangle_outline(baseX + 38, baseY + 38, 75, 75, black, 3)
    if num == 1:
        arcade.draw_points([p4], black, 10)
    if num == 2:
        arcade.draw_points([p3, p5], black, 10)
    if num == 3:
        arcade.draw_points([p1, p4, p7], black, 10)
    if num == 4:
        arcade.draw_points([p1, p3, p5, p7], black, 10)
    if num == 5:
        arcade.draw_points([p1, p3, p4, p5, p7], black, 10)
    if num == 6:
        arcade.draw_points([p1, p2, p3, p5, p6, p7], black, 10)
...
def drawDice(num1, num2, availableRolls):
    ...
    if num2 in tempList:
        U4 = False
        tempList.remove(num2)
    diceSub(1040, 485, num1, white if U1 == False else arcade.color.CHARCOAL)
    diceSub(1140, 485, num2, white if U2 == False else arcade.color.CHARCOAL)
    if num1 == num2:
        diceSub(1040, 395, num1, white if U3 == False else arcade.color.CHARCOAL)
        diceSub(1140, 395, num2, white if U4 == False else arcade.color.CHARCOAL)
...
def drawPIP(pip):
    ...
    arcade.draw_text(pip[0], 75, 15, white, 20, 150, "center", "arial")
    arcade.draw_text(pip[1], 75, 765, white, 20, 150, "center", "arial")
    ...
    for move in possibleMoves:
        ...
        if startPoint == 1001:
            ...
            for pc in range(len(board_bar_list)):
                ...
                if doDraw == True:
                    tempSprite = arcade.Sprite("backgammon/Images/Move.png", 0.07)
...
def createMoveEndSprites(activeSprite, Board):  # UPDATE NEEDED
    ...
    for move in activeSprite.move[1]:
        ...
        if move == 2002:
            tempSprite = arcade.Sprite("backgammon/Images/Submove.png", .07)
...
def DrawSimMain():
    arcade.draw_rectangle_filled(1098, 285, 175, 40, white)
