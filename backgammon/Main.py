...
try:
    ...
    from backgammon.Main_Files import Views as Views

SCREEN_WIDTH = 1350
SCREEN_HEIGHT = 850
BACKGROUND_COLOR = 0, 30, 40
...
class MainWindow(arcade.Window):
    ...
    def setup(self):
        main_menu_view = Views.StartMenuView(BACKGROUND_COLOR)
...
def main():
    main_window = MainWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "Backgammon - Stuart")
